	...
	return (
		<main className={styles.main}>
			...
			<div className={styles.signup}>
				...
				<button>
					<a href='https://api.intra.42.fr/oauth/authorize?client_id=41f9a237a56553748d98c4b803438728f91444b39b0cf4dff86f88874431bb6f&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fredirect&response_type=code'>
